...
# read in data #
suppl_table_2 <- fread(file = "project/Genome_biology_submission/supplementary_tables/Supplementary_Table2.tsv")
suppl_table_3 <- fread(file = "project/Genome_biology_submission/supplementary_tables/Supplementary_Table3.tsv")
