...
markerz_our_cat <- merge(markerz_our, suppl_table5, by.x = "gene_name", by.y = "gene")
...
plot_fin_alles <- as.ggplot(expression(
  ...
  kpAxis(kp, data.panel = 1, r0 = 0.1, r1 = 0.1, cex=0.5,
         labels = paste0("PAR ", length(unique(markerz_our_cat_PAR$gene_name)))), 
  kpPoints(kp, 
  ...
  kpAxis(kp, data.panel = 1, r0 = 0.15, r1 = 0.15, cex=0.5, 
         labels = paste0("biallelic ", length(unique(markerz_our_cat_always_biallelic$gene_name)))),
  kpPoints(kp, 
  ...
  kpAxis(kp, data.panel = 1, r0 = 0.2, r1 = 0.2, cex=0.5, 
         labels = paste0("monoallelic ", length(unique(markerz_our_cat_always_monoallelic$gene_name)))),
  kpPoints(kp, 
  ...
  kpAxis(kp, data.panel = 1, r0 = 0.25, r1 = 0.25, cex=0.5, 
         labels = paste0("variable ", length(unique(markerz_our_cat_variable$gene_name))))
  )
  )
...
Tuki_UPIC <- fread("project/Genome_biology_submission/annotation_data/Suppl.Table.5.csv")
...
plot_fin_allez_gene_labels <- as.ggplot(expression(
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[1:31]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1,
                cex = 0.35,
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[32:63]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[64:95]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[96:127]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[128:159]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[160:191]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[192:223]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[224:249]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[250:280]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[281:311]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[312:342]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[343:373]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[374:392]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 1, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
  ...
  kpPlotMarkers(kp, 
                ...
                label.color = colByCategory(markerz[393:401]$TUKI, colors=c("#00A651", "#662D91")),
                data.panel = 2, 
                cex = 0.35,
                adjust.label.position = F,
                ignore.chromosome.ends = T
...
ggsave2(filename = paste0(plot_dir, "Suppl_Fig_1A.pdf"), height = 14, width = 24, units = "cm",
