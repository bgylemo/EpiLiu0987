...
# Annotation data
# tuki df
#tukiainen <- subset(fread("project/Genome_biology_submission/annotation_data/landscape.Suppl.Table.13.csv", header = T), !is.na(XCI_across_tissues) & XCI_across_tissues != "")
tukiainen <- fread("project/Genome_biology_submission/annotation_data/Suppl.Table.5.csv", header = T)
