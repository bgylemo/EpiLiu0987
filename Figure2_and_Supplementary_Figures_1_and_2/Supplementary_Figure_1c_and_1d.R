...
ggplot(df_overlaps, aes(x=participant1, y=participant2)) + geom_point() + stat_cor()


df_overlaps_with_class <- merge(df_overlaps, suppl_table6, by = "gene")


ggsave2(filename = paste(plot_dir, "Supplementary_figure_1c.pdf"),
...
ggsave2(filename = paste0(plot_dir, "Supplementary_figure_1d.pdf"),
